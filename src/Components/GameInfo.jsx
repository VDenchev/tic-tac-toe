		...
		<div className="flex items-center flex-col sm:items-start sm:w-[40%]">
			{winner === "" ? (
				...
				<>
					...
					<button
						className="mt-8 p-6 rounded-2xl bg-poppy-100 hover:bg-poppy-900 dark:bg-poppy-200 hover:dark:bg-poppy-200/95 text-2xl text-westar dark:text-grey font-bold shadow-sm border border-dark-900/10"
						onClick={handleClick}>
						Play again!
					</button>
				</>
